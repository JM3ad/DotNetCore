...
export default class Home extends React.Component<RouteComponentProps<{}>, {}> {
    public render() {
        return <div>
            <h1>Welcome, Captain of Gondor</h1>
            <p>They are coming.</p>
            <p>The enemy have been preparing for war and just as we have been burying spies deep within their ranks, we believe they have also infiltrated our own - choose your compatriots carefully. </p>
            ...
            <ul>
                ...
                <li>Share this intelligence with your colleagues and establish the best routes to ambush</li>
